	...
	theme: {
		extend: {
			colors: {
				...
				'adp-gray': '#ebf1f2',
				'adp-dark-gray': '#555',
				'adp-primary-blue': '#4184F3',
				'adp-primary-blue-active': '#A5F3FC',
				'adp-primary-active': '#A5F3FC',
				'adp-primary-blue-hover': '#0ea5e9',
				'adp-primary-orange': '#DF514C',
				'adp-primary-orange-hover': '#f97316',
				'adp-primary-green': '#4CAF50',
				'adp-primary-green-hover': '#84cc16',
				'adp-primary-yellow': '#FFCB48',
				'adp-border': '#adadad',
				'adp-border-primary': '#4184F3',
				'adp-secondary': '#F5F5F5',
				'adp-tertiary': '#DDDDDD',
				'adp-tertiary-blue': '#4184F3',
				'adp-text-tertiary-hover': '#fff',
